...
vmscfgdir="${HOME}/VBoxHardenedLoader/Binary/data"
...
randtext=`< /dev/urandom tr -dc A-Z | head -c6`
r8=`< /dev/urandom tr -dc AZ09 | head -c8`
r4=`< /dev/urandom tr -dc AZ09 | head -c4`
r41=`< /dev/urandom tr -dc AZ09 | head -c4`
d1=`shuf -i 1-28 -n 1`
d2=`shuf -i 1-12 -n 1`
d3=`shuf -i 11-15 -n 1`
...
$vboxman setextradata "$n1" "VBoxInternal/Devices/pcbios/0/Config/DmiBIOSVersion" "GP00.36Y.0099.B06.0904152222"
...
$vboxman modifyvm "$n1" --macaddress1 84C9B21A124D
...
#$vboxman modifyvm "$n1" --bioslogoimagepath  "$vmscfgdir/2.bmp"
